...
fn entry_follows_policy_layout() {
    let out = changelog(
        ...
        "stable",
        "low",
        &[release("0.5.3", vec![commit("Add changelog", "")])],
    );
    ...
    assert_eq!(
        lines[4],
        " -- Vlad Kartsaev <vkarcaev@gmail.com>  Wed, 10 Sep 2026 12:00:00 +0300"
    );
}
